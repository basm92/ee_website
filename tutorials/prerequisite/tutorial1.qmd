...
subtitle: "Tutorial 1: Statistics and Probability"
mainfont: Lato
...
format:
  revealjs: 
    ...
    logo: logo.svg
    css: styles.css
    footer: 'Empirical Economics: Tutorial - Statistics and Probability'
resources:
  - demo.pdf
---
...
- Bas Machielsen ([a.h.machielsen@uu.nl](mailto:a.h.machielsen@uu.nl]))

Tutorial teachers:

- Teacher 1: [x](mailto:x@uu.nl)
- Teacher 2: [x](mailto:y@uu.nl)
- Teacher 3: [z](mailto:z@uu.nl)

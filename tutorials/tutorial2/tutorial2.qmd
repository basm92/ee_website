...
- Link to Wooclap quiz: [https://app.wooclap.com/OFZFSD/questionnaires/68c70d19411de4235e9a9d81](https://app.wooclap.com/OFZFSD/questionnaires/68c70d19411de4235e9a9d81)
...
# Model 1: Estimating price with sqrft, bdrms, and lotsize
model1 <- lm(price ~ sqrft + bdrms + lotsize, data = hprice1)

# Model 2: Estimating price with sqrft, bdrms, and colonial style
model2 <- lm(price ~ sqrft + bdrms + colonial, data = hprice1)

modelsummary(list(model1, model2),
             stars=c("*"=0.1, "**"=0.05, "***"=0.01), 
             gof_map=c("nobs", "r.squared"),
             title="Regression of Housing Price on Characteristics",
             width=0.3,
             notes="Standard Errors in parentheses.") |>
  theme_revealjs(css='light', fontsize=0.8)

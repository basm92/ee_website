...
[Wooclap Link](https://app.wooclap.com/OFZFSD/questionnaires/68dcfc536ad64f169e0e157e)
...
:::{style="font-size:0.7em;"}
  ...
  b) Construct the first-differenced variables $\Delta y_{it} = y_{it} - y_{i,t-1}$ and $\Delta x_{it} = x_{it} - x_{i,t-1}$. How many observations do you have in your differenced dataset? Also suppose $\beta=2$. Calculate the residuals for both models.

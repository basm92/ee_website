...
[Wooclap Link](https://app.wooclap.com/OFZFSD/questionnaires/68ef4ee8cccf17ab6c6293de)
...
probit <- feglm(pira ~ p401k + inc + marr + male + age, data = abadie, family = binomial(link = "probit"), vcov='hc1')

...
a) Create a dummy variable indicating whether `educ`>12. 
a) Manually compute the Wald estimator. 
a) Recreate the table in R/Python/Stata.
b) Interpret the first stage.

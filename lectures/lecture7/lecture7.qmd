...
$$\text{ATT} = E[\tau_i | T=1] = E[Y_i(1) - Y_i(0) | T_i=1]$$
...
\begin{align}
\text{ATT} &= E[Y_{i1}(1) | D_i=1] - E[Y_{i1}(0) | D_i=1] \\
    &= E[Y_{i1}(1) | D_i = 1] - \underbrace{E[Y_{i0}(0) | D_i=1]}_{\text{Treated pre-treatment}} + \\ &\underbrace{\left( E[Y_{i1}(0) | D_i=0] - E[Y_{i0}(0) | D_i=0] \right)}_{\text{Change in control group}} \\
    &= E[Y_{i1}(1) | D_i=1] - \\
...
$Y_{it} = \beta_0 + \beta_1 D_i + \beta_2 Post_t + \beta_3(D_i × Post_t) + \epsilon_{it}$

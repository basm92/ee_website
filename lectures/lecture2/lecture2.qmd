...
In estimating the effect of education ($X_1$) on wages ($Y$), innate ability is a classic confounder. Ability is likely correlated with how much education someone pursues and their potential earnings. Controlling for a proxy of ability (like an IQ test score, $X_2$) helps to prevent the estimated return to education from being biased upwards.

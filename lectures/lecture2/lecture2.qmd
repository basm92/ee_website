...
- For example, if you know an observation is not in the North, South, or East, it must be in the West. This redundancy makes it impossible for the model to estimate the individual effect of each category.

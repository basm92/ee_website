...
- In the third week we considered the following static time-series model. It is based on a data set containing outcomes for one firm, which is observed over *T* periods.
...
- In this euqation,  we add a subscript *t* for the *t*-th period:

...
c) Using your answers from (a) and (b), determine the direction of the bias on the educ coefficient in the simple model. Will the simple model likely overestimate or underestimate the true effect of education on wages? Explain your reasoning by referencing the formula/logic for Omitted Variable Bias.
